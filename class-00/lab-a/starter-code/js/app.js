...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: Bc it's outside of the scope, you can't access. Moved console log into function to see if it would work just to see and it did.
  console.log(viewed);
