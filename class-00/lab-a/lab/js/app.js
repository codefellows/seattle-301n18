...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error 
  //when we changed the letiable declaration from `var to `const`.
  // PUT YOUR RESPONSE IN THIS COMMENT: an error is thrown because VAR has global scope while LET has only block scope.  
  //moving the console log into the displayPics function code block removes the scoping issue and clears the error. 
  console.log(viewed);
