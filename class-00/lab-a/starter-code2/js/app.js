...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT the console log exists outside of the block-scoped let named 'rando'; stated negatively, it is not hoised outside of the block
  console.log(viewed);
